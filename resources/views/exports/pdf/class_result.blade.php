...
<head>
    <meta charset="UTF-8">
    <title>Hasil Ujian - {{ $exam->title }} - Kelas {{ $schoolClass->name }}</title>
    <style>
...
<body>
    ...
    <div class="title">LAPORAN HASIL UJIAN PER KELAS</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center">Belum ada data hasil ujian yang final untuk kelas ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
