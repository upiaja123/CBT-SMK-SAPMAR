<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('viewAny', App\Models\QuestionBank::class)
                    <x-nav-link :href="route('question_banks.index')" :active="request()->routeIs('question_banks.*')">
                        {{ __('Bank Soal') }}
                    </x-nav-link>
                    @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden max-h-[calc(100vh-4rem)] overflow-y-auto">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('viewAny', App\Models\QuestionBank::class)
            <x-responsive-nav-link :href="route('question_banks.index')" :active="request()->routeIs('question_banks.*')">
                {{ __('Bank Soal') }}
            </x-responsive-nav-link>
            @endcan
