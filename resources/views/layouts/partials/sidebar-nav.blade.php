...
<div class="space-y-1">
    ...
    <a href="{{ route('dashboard') }}"
        ...
        <svg class="w-5 h-5 flex-shrink-0 text-sapta-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
    ...
    @if ($role === 'super_admin' || $role === 'kurikulum')
        ...
        <a href="{{ route('audit-logs.index') }}"
            ...
            <svg class="w-4 h-4 text-sapta-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            Audit Log
        </a>
    ...
    @canany(['question_banks.view', 'exams.create', 'exams.update', 'exams.monitor'])
        ...
        <a href="{{ route('question_banks.index') }}"
            ...
            <svg class="w-4 h-4 text-sapta-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
            Bank Soal
        </a>
        @endcan
        ...
        <a href="{{ route('exams.index') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm transition {{ request()->routeIs('exams.*') && !request()->routeIs('exams.monitoring.*') ? 'bg-white/15 text-white font-semibold' : 'text-sapta-100 hover:bg-white/10 hover:text-white' }}">
            <svg class="w-4 h-4 text-sapta-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            Manajemen Ujian
        </a>
        @endcanany
    @endcanany
    ...
    <a href="{{ route('profile.edit') }}"
        ...
        <svg class="w-4 h-4 text-sapta-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
        Profil Saya
    </a>
